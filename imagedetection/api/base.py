...
class Serial_DetectionAPIView():
    ...
    def __init__(self):
        ...
        self.loaded_model_aphabets = tf.keras.models.load_model(
            ('imagedetection/api/my_model_alphabets_v3_4.h5'),
            custom_objects={'KerasLayer':hub.KerasLayer}
        )

        # self.loaded_model_aphabets_v1 = tf.keras.models.load_model(
        #     ('imagedetection/api/my_model_alphabets_v3_1.h5'),
        #     custom_objects={'KerasLayer':hub.KerasLayer}
        # )

        # self.loaded_model_aphabets_v2 = tf.keras.models.load_model(
        #     ('imagedetection/api/my_model_alphabets_v3_2.h5'),
        #     custom_objects={'KerasLayer':hub.KerasLayer}
        # )
